...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative pt-16 pb-32 overflow-hidden bg-gradient-to-br from-sgc-purple-light via-white to-sgc-blue-light">
        <div className="sgc-container relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute top-1/3 left-0 w-40 h-40 bg-sgc-purple/5 rounded-full -translate-x-1/2"></div>
              <div className="absolute bottom-1/4 right-1/4 w-20 h-20 bg-sgc-blue/10 rounded-full"></div>
            </div>
          </div>
        </div>
        
        {/* Background decorative elements */}
        <div className="absolute top-1/4 right-0 w-80 h-80 bg-sgc-purple/5 rounded-full"></div>
        <div className="absolute bottom-0 left-1/4 w-60 h-60 bg-sgc-blue/5 rounded-full"></div>
      </section>
